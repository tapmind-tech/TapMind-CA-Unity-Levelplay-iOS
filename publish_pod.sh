...
PODSPEC_NAME="TapMindISAdapter.podspec"
...
git commit -m "Added case-insensitive key handling for JSON parsing to ensure consistent and reliable data access regardless of key casing"
git tag "$VERSION"
